...
return new class extends Migration {
    ...
    {
        Schema::create('mu5tj_longsong_hb2', function (Blueprint $table) {
            $table->id();
            ...
            $table->float('titik_31');
            $table->float('titik_32');
            $table->float('titik_33');
            $table->float('titik_34');
            $table->float('titik_35');
    ...
    {
        Schema::dropIfExists('mu5tj_longsong_hb2');
    }
};
