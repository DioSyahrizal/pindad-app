    ...
    <div class="row pt-3">
        ...
        <div id="step2" style="display: {{ $currentStep != 2 ? 'none' : '' }}">
            ...
            <div class=" bg-white rounded my-4">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th colspan="2" class="text-center">Titik 1</th>
                        <th colspan="2" class="text-center">Titik 2</th>
                        <th colspan="2" class="text-center">Titik 3</th>
                    </tr>
                    <tr>
                        <th>MIN</th>
                        <th>MAX</th>
                    ...
                    @if($specTable)
                        @foreach($specTable as $spec)
                            <tr>
                                ...
                                <td>{{$spec->specDetail->attribute['titik1_min']}}</td>
                                <td>{{$spec->specDetail->attribute['titik1_max']}}</td>
                                <td>{{$spec->specDetail->attribute['titik2_min']}}</td>
                                <td>{{$spec->specDetail->attribute['titik2_max']}}</td>
                                <td>{{$spec->specDetail->attribute['titik3_min']}}</td>
                                <td>{{$spec->specDetail->attribute['titik3_max']}}</td>
                            </tr>
                        @endforeach
                    @endif
            ...
            <table class="table bg-white rounded">
                ...
                <tr>
                    <th scope="col">#</th>
                    <th scope="col">Titik 1</th>
                    <th scope="col">Titik 2</th>
                    <th scope="col">Titik 3</th>
                </tr>
                </thead>
                <tbody>
                @for($i = 1; $i <= 5; $i++)
                    ...
                    <tr>
                        ...
                        <td class="input--custom-group">
                            <input class="numeric" type="numeric" wire:model="{{$key3}}"
                                   id="input-number"
                                   min="0"
                                   aria-describedby="{{$key3}}"
                                   placeholder="titik 3.{{$i}}"
                            >
                            <div class="{{$errors->first($key3)  ? 'error' : ''}}"/>
                        </td>
                    </tr>
                @endfor
                </tbody>
